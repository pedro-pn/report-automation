...
// var ReportTypesString = { ver como vai ficar essa substituição
// 	0: "RDO",
// 	1: "RTP",
// 	2: "RLQ",
// 	3: "RCP",
...
type ServiceFieldResponses = {
	[key in HeaderFields | FormServicesFields]?: fieldResponse;
};
...
enum FormServicesFields  {
	...
	DehydrationImg = "Análise de umidade/desidratação",
...
enum FormRLIFields {
	...
	System = "Nome do sistema",
 	...
 	PipeDraw = "Código do desenho da tubulação",
