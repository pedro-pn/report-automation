function addItemToSpecificSectionAndPlace() {
    ...
    for (var service = 0; service < 9; service++) {
      ...
      newItem.setTitle('Selecione os manômetros utilizados').setHelpText("O código PI pode ser encontrado na lateral do manômetro")
            ...
            newItem.createChoice('PI-76'),
            newItem.createChoice('PI-77'),
            newItem.createChoice('PI-78'),
            newItem.createChoice('PI-79'),
            newItem.createChoice('PI-100'),
            newItem.createChoice('MAN-30'),
            newItem.createChoice('MAN-31'),
            newItem.createChoice('MAN-32'),
            newItem.createChoice('MAN-33'),
            newItem.createChoice('MAN-34'),
            newItem.createChoice('MAN-35'),
            newItem.createChoice('MAN-70'),
            newItem.createChoice('MAN-71'),
            newItem.createChoice('MAN-72'),
            newItem.createChoice('MAN-73'),
            newItem.createChoice('MAN-74'),
            newItem.createChoice('MAN-75'),
            newItem.createChoice('MAN-76'),
            newItem.createChoice('MAN-77'),
            newItem.createChoice('MAN-78'),
            newItem.createChoice('MAN-79'),
            newItem.createChoice('MAN-80'),
            newItem.createChoice('MAN-81'),
            newItem.createChoice('LP-610 573'),
            newItem.createChoice('LP-610 574'),
            newItem.createChoice('LP-610 575'),
            newItem.createChoice('LP-610 576'),
            newItem.createChoice('LP-610 577'),
            newItem.createChoice('LP-610 578'),
            newItem.createChoice('LP-610 579'),
            newItem.createChoice('LP-610 580'),
            newItem.createChoice('LP-610 581'),
            newItem.createChoice('LP-610 582'),
            ]).setRequired(false);
